  ...
  async function generateAndPlayWelcomeMessage(
    ...
    try {
      ...
      if (photo.base64) {
        ...
        - For example: 'Cloudy Eiffel Tower day—your hat, scarf, and coat look cinematic. In 20 minutes, capture 4 shots: Trocadéro, Avenue de Camoëns, Bir-Hakeim Bridge, and Quai Branly. Panoramas, chic streets, dramatic lines, and river reflections await. Start with your current spot!'`;
    ...
    <View style={styles.container}>
      ...
      <View style={styles.bottomBar}>
        ...
        <View style={styles.galleryButtonContainer}>
          {thumbnailUrl && (
            <Link href={{ pathname: "/inspos", params: { images: JSON.stringify(instagramImages) } }}>
